...
sudo cp /var/www/ghnp/code/solr/schema.xml solr-6.4.1/server/solr/configsets/ghnp/conf/schema.xml
sudo cp /var/www/ghnp/code/solr/solrconfig.xml solr-6.4.1/server/solr/configsets/ghnp/conf/solrconfig.xml
