...
class HTMLCalendar(calendar.Calendar):
    ...
    def formatday(self, year, month, day, weekday):
        ...
        if day == 0:
            ...
            if count == 1:
                ...
                if self.all_issues:
                    # will want to inform user which newspaper they are linking to
                    # using a bootstrap dropdown menu
                    ...
                    # if specific paper then link directly from the date clicked
    ...
    def formatmonthname(self, theyear, themonth, withyear=True):
        ...
        return '<tr><th colspan="7" class="title">%s, %s</td></tr>' % (s,
                                                                       theyear)
    ...
    def formatyear(self, theyear, width=3):
        ...
        for i in range(calendar.January, calendar.January + 12, width):
            ...
            for m in months:
                a('<div class="col-md-3 calendar_month">')
...
def _get_tip(lccn, date, edition, sequence=1):
    ...
    try:
        ...
        raise Http404('Problem locating issue with date: %s and edition: %s.' % _date, edition)
    try:
